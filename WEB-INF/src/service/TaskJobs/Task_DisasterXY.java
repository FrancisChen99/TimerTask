...
public class Task_DisasterXY implements Job{
    ...
    public void execute(JobExecutionContext arg0) throws JobExecutionException {
        ...
        try{
          ...
          java.util.ArrayList Data=mdsDB.getDataArrayList(mdsDB.exeQuery(
                                   ...
                                   "('Task_DisasterXY_DOWNLOAD','Task_DisasterXY_DOWNLOAD_Flag')"));
          ...
          for(int i=0;i<Data.size();i++){
            ...
            if(strSet_Name.equals("Task_DisasterXY_DOWNLOAD"))
              strUrl=(TempData.get(1)==null?"":TempData.get(1).toString());
            else if(strSet_Name.equals("Task_DisasterXY_DOWNLOAD_Flag"))
