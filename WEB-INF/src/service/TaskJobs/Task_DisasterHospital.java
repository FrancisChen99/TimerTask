...
public class Task_DisasterHospital implements Job{
    ...
    public void execute(JobExecutionContext arg0) throws JobExecutionException {
        ...
        try{
          ...
          java.util.ArrayList Data=mdsDB.getDataArrayList(mdsDB.exeQuery(
                                   ...
                                   "('Task_DisasterHospital_DOWNLOAD','Task_DisasterHospital_DOWNLOAD_Flag')"));
          ...
          for(int i=0;i<Data.size();i++){
            ...
            if(strSet_Name.equals("Task_DisasterHospital_DOWNLOAD"))
              strUrl=(TempData.get(1)==null?"":TempData.get(1).toString());
            else if(strSet_Name.equals("Task_DisasterHospital_DOWNLOAD_Flag"))
