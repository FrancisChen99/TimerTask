...
public class Task_DisasterChemicals implements Job{
    ...
    public void execute(JobExecutionContext arg0) throws JobExecutionException {
        ...
        try{
          ...
          java.util.ArrayList Data=mdsDB.getDataArrayList(mdsDB.exeQuery(
                                   "select SET_NAME,SET_VALUE from DIS_CONFIG where SET_NAME IN "+ 
                                   "('Task_DisasterChemicals_DOWNLOAD','Task_DisasterChemicals_DOWNLOAD_Flag')"));
          ...
          for(int i=0;i<Data.size();i++){
            ...
            if(strSet_Name.equals("Task_DisasterChemicals_DOWNLOAD"))
              strUrl=(TempData.get(1)==null?"":TempData.get(1).toString());
            else if(strSet_Name.equals("Task_DisasterChemicals_DOWNLOAD_Flag"))
